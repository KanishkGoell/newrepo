...
const USERS_BIN_ID = '66644a1aacd3cb34a8547fc9';
const PREFS_BIN_ID = '66644929e41b4d34e4004d98';
const JSONBIN_API_KEY = '$2a$10$y8z0jEU7iMUzrd1ZQTrHKeh6yYbIMKMLeGMAsxgCoWzaUUyUKwYhO';
...
const readBinFromJSONBin = async (binId) => {
    try {
        ...
        console.error('Error reading bin from JSONBin:', err);
        return null;
    }
};
...
const writeBinToJSONBin = async (binId, data) => {
    try {
        ...
        console.error('Error writing bin to JSONBin:', err);
    }
};
